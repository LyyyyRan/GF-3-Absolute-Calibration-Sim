...
Profile_Position = [873 - 1, 1274 - 1]  # matlab from 1 on, python from 0 on
...
ROI_BBox_show = cv.rectangle(ROI_BBox_show, (167, 0), (199, Na - 1), color=(255, 0, 0), thickness=1)  # Azimuth longer
ROI_BBox_show = cv.rectangle(ROI_BBox_show, (0, 140), (Nr - 1, 212), color=(255, 0, 0), thickness=1)  # Range longer
...
# the Setting RCS:
RCS = eval(mat_path.split('RCS_')[-1].split('_')[1])
...
# Calibration:
Calibration_K = Energy / RCS / N_factor
